...
class OrderDetailsResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            "subtotal_without_tax_currency_price" => AppLibrary::currencyAmountFormat($this->subtotal),
            ...
            "total_currency_price"                => AppLibrary::currencyAmountFormat($this->total + $this->total_tax),
