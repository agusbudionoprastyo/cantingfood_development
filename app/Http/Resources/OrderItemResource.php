...
class OrderItemResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        return [
            ...
            'total_currency_price'             => AppLibrary::currencyAmountFormat($this->total_price + $this->total_tax),
            ...
            'total_without_tax_currency_price' => AppLibrary::currencyAmountFormat($this->total_price),
        ];
    }
}
