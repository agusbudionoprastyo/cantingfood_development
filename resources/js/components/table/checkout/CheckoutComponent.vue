                            ...
                            <div class="rounded-xl mb-6 border border-[#EFF0F6]">
                                <ul class="flex flex-col gap-2 p-3 border-b border-dashed border-[#EFF0F6]">
                                    ...
                                    <li class="flex items-center justify-between text-heading">
                                        ...
                                        <span class="text-sm leading-6 capitalize">
                                            {{
                                                currencyFormat(totalTax, setting.site_digit_after_decimal_point, setting.site_default_currency_symbol, setting.site_currency_position)
                                            }}
                                        </span>
                                    </li>
                                </ul>
                                <div class="flex items-center justify-between p-3">
                                    ...
                                    <h5 class="text-sm leading-6 font-semibold capitalize">
                                        {{
                                            currencyFormat(subtotal + totalTax, setting.site_digit_after_decimal_point, setting.site_default_currency_symbol, setting.site_currency_position)
                                        }}
                                    </h5>
                                </div>
                            </div>
    ...
    methods: {
        ...
        async testEndpoint() {
            ...
            const payload = {
                ...
                \n\n_Item_\n${this.carts.map(cart => cart.quantity + ' ' + cart.name + ' Variation: ' + cart.item_variations.names + ' Extra: ' + cart.item_extras.names + ' Instruction: ' + cart.instruction).join(', ')}
                ...
                \n_Terima kasih & selamat bekerja_`,
