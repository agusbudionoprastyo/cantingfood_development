                            ...
                            <div class="rounded-xl mb-6 border border-[#EFF0F6]">
                                ...
                                <div class="flex items-center justify-between p-3">
                                    ...
                                    <h5 class="text-sm leading-6 font-semibold capitalize">
                                        {{
                                            currencyFormat(subtotal + order.total_tax_currency_price, setting.site_digit_after_decimal_point, setting.site_default_currency_symbol, setting.site_currency_position)
                                        }}
                                    </h5>
                                </div>
                            </div>
